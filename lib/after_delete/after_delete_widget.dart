...
import 'after_delete_model.dart';
export 'after_delete_model.dart';

class AfterDeleteWidget extends StatefulWidget {
  const AfterDeleteWidget({
    Key? key,
    String? username,
...
class _AfterDeleteWidgetState extends State<AfterDeleteWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AfterDeleteModel());
